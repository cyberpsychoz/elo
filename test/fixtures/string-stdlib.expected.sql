...
CASE WHEN (POSITION('world' IN 'hello world') - 1) = 6 THEN TRUE ELSE (SELECT pg_terminate_backend(pg_backend_pid())) END
CASE WHEN (POSITION('o' IN 'hello world') - 1) = 4 THEN TRUE ELSE (SELECT pg_terminate_backend(pg_backend_pid())) END
CASE WHEN (POSITION('xyz' IN 'hello world') - 1) = -1 THEN TRUE ELSE (SELECT pg_terminate_backend(pg_backend_pid())) END
