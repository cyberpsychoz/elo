...
(raise "Assertion failed" unless ("hello world".index("world") || -1) == 6; true)
(raise "Assertion failed" unless ("hello world".index("o") || -1) == 4; true)
(raise "Assertion failed" unless ("hello world".index("xyz") || -1) == -1; true)
